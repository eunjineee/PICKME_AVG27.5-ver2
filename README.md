...
1차 프로젝트에서의 아쉬움을 담아 ver2로 업그레이드를 해 보았습니다. 시간상 해보지 못했던 search bar를 구현했는데 생각보다 간단한 로직이어서 아쉬움이 남았습니다. 

가장 해보고 싶었던 소셜로그인을 함께 시도했으나 완전한 기능을 하지 못하였습니다. 하지만 dj-rest-auth 로그인 기능과 소셜 로그인의 과정을 깊이 이해할 수 있었습니다.
