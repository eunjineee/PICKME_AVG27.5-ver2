<template>
    <div>
      <b-form-input size="sm" class="mr-sm-2" v-model="inputData" placeholder="영화를 검색해보세요"></b-form-input>
      <b-button size="sm" class="my-2 my-sm-0" type="submit" @click="searchMovie">Search</b-button>
      <div v-if="issearch">
